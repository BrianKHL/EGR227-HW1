...
public class HtmlValidator {
    ...
    public void removeAll(String element) {
        ...
        //removes matching tags using tags.removeIf with a lambda expression.
    ...
    public void validate() {
        ...
        for(int i = 0; i < tags.size(); i++) {
            ...
            if (tag.isSelfClosing()) {
                ...
                //print the correct message for unexpected tags base on the spec
    ...
    private static void printWithIndentation(HtmlTag tag, int indentationLevel) {
        ...
        for (int i = 0; i < indentationLevel; i++) {
            //append the INDENTATIOTON_MARKER
